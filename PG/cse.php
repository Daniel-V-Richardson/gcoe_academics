...
<body>
    ...
    <!-- ENDS -->
    <h1 class="course-main-headng">Computer Science & Engineering</h1>
    <div class="tb-main">
                ...
                <div class="demo-card-wrapper">
                    <div class="demo-card demo-card--step1">
                        ...
                        <div class="body">
                            <p>
                            <ul>
                                <li>The Department of Computer Science and Engineering which offers PG programme in 2013.</li>
                                ...
                                <li>The department is fully Equipped with campus wifi and Internet facilities</li>
                            </ul>
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="demo-card demo-card--step1">
                        ...
                        <div class="body">
                            <p>
                            <ul>
                                <li>To provide quality education by inculcating strong fundamentals in basic science , mathematics and engineering concepts through the state of the art facilities.</li><br>
                                <li>To provide the learning ambience that helps the students to enhance problem solving skills and to inculcate in them the habit of continuous learning in their domain of interest.</li><br>
                                <li>To serve the society by providing insight solutions to the real world problems by employing the latest trends of computing technology with strict adherence to professional and ethical responsibilities.</li><br>
                    ...
                    <div class="demo-card demo-card--step1">
                        ...
                        <div class="body">
                            <p>
                            <ul>
                                <li>1. To enable graduates to pursue research, or have a successful career in academia or industries associated with Computer Science and Engineering, or as entrepreneurs.</li><br>
                                <li>2. To provide students with strong foundational concepts and also advanced techniques and tools in order to enable them to build solutions or systems of varying complexity.</li><br>
                                <li>3. To prepare students to critically analyze existing literature in an area of specialization and ethically develop innovative and research oriented methodologies to solve the problems identified.</li><br>
                            </ul>
                            </p>
                        </div>
                    </div>
                    <div class="demo-card demo-card--step1">
                        ...
                        <div class="body">
                            <p>
                            <ul>
                                <li>1. Engineering knowledge: Apply the knowledge of mathematics, science, engineering fundamentals, and an engineering specialization to the solution of complex engineering problems.</li><br>
                                <li>2. Problem analysis: Identify, formulate, review research literature, and analyze complex engineering problems reaching substantiated conclusions using first principles of mathematics, natural sciences, and engineering sciences.</li><br>
                                <li>3. Design/development of solutions: Design solutions for complex engineering problems and design system components or processes that meet the specified needs with appropriate consideration for the public health and safety, and the cultural, societal, and environmental considerations.</li><br>
                                <li>4. Conduct investigations of complex problems: Use research-based knowledge and research methods including design of experiments, analysis and interpretation of data, and synthesis of the information to provide valid conclusions.</li><br>
                                <li>5. Modern tool usage: Create, select, and apply appropriate techniques, resources, and modern engineering and IT tools including prediction and modeling to complex engineering activities with an understanding of the limitations.</li><br>
                                <li>6. The engineer and society: Apply reasoning informed by the contextual knowledge to assess societal, health, safety, legal and cultural issues and the consequent responsibilities relevant to the professional engineering practice.</li><br>
                                <li>8. Ethics: Apply ethical principles and commit to professional ethics and responsibilities and norms of the engineering practice.</li><br>
                                <li>9. Individual and team work: Function effectively as an individual, and as a member or leader in diverse teams, and in multidisciplinary settings.</li><br>
                                <li>10. Communication: Communicate effectively on complex engineering activities with the engineering community and with society at large, such as, being able to comprehend and write effective reports and design documentation, make effective presentations, and give and receive clear instructions.</li><br>
                                <li>11. Project management and finance: Demonstrate knowledge and understanding of the engineering and management principles and apply these to one‘s own work, as a member and
                                    leader in a team, to manage projects and in multidisciplinary environments.</li><br>
                                <li>12. Life-long learning: Recognize the need for, and have the preparation and ability to engage in independent and life-long learning in the broadest context of technological change.</li><br>
                            </ul>
                            </p>
                        </div>
                    </div>
                    <div class="demo-card demo-card--step1">
                        ...
                        <div class="body">
                            <p>
                                To analyze, design and develop computing solutions by applying foundational concepts of Computer Science & Engineering.
        ...
        <section id="content2">
            <div class="content">
                ...
                <ul class="team">
                    <li class="member">
                        <div class="thumb"><img src="../assets/img/academics/cse/lab1.jpg"></div>
                        <div class="lab_container">
                            <div class="description">
                                <h3 class="lab-heading">Infrastructure and Lab Facilities</h3>
                                <ul>
                                    <li>The department labs are well equipped to make students grasp the technologies and code the programs effectively.</li>
                                    <li>Computer Laboratory - I and Computer Laboratory - II are equipped with LAN and 24- hour high speed internet facility.</li>
                                    <li>Ample number of dot matrix and laser printers are made available for students to take printouts for lab purpose.</li>
                                </ul>
                            </div>
                            <div class="lab_image">
                    ...
                    <li class="member">
                        <div class="thumb"><img src="../assets/img/academics/cse/lab1.png"></div>
                        <div class="lab_container">
                            <div class="description">
                                <h3 class="lab-heading">Big Data Analytics Laboratory</h3>
                                <ul>
                                    <li>Established in the year 2017-2018</li>
                                    <li>Well equipped with highly developed hardware's in high configuration</li>
        ...
        <section id="content3">
            ...
            <div class="profile-container">
                ...
                <!--    <div class="our-team">-->
                <!--        <div class="picture">-->
                            <!--<img class="img-fluid" src="https://res.cloudinary.com/gracecoe/image/upload/v1666358836/Assets/Faculty/CSE/director_decbxo.jpg">-->
                <!--        </div>-->
                <!--        <div class="faculty-name">-->
                <!--            Dr. J. Mercy Geraldine-->
                <!--            <h4 class="title">Associate Professor</h4>-->
                <!--        </div>-->
                <!--        <div class="social">-->
                            <!--<a href="../assets/doc/Faculty Profile/kirubakaran.pdf#toolbar=0" target="pdf" class="link">View Profile</a>-->
                <!--        </div>-->
                <!--    </div>-->
                <!--</div>-->
