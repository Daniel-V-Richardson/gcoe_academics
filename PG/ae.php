...
<head>
    ...
    <title>GCOE:Applied Electronics</title>
...
<body>
    ...
    <!-- ENDS -->
    <h1 class="course-main-headng">Applied Electronics</h1>
    <div class="tb-main">
            ...
            <div id=timeline>
                ...
                <div class="demo-card-wrapper">
                    ...
                    <div class="demo-card demo-card--step1">
                        ...
                        <div class="body">
                            <p>
                                To be a center of excellence in innovation by educating professionals and technocrats to meet the growing Technological and socio-economic needs. </p>
                        </div>
                    </div>
                    <div class="demo-card demo-card--step1">
                        <div class="head">
                        ...
                        <div class="body">
                            <p>
                            <ul>
                                <li>To develop the ability to utilize technology in emerging areas to address the issues and to improve the livelihood of the society</li><br>
                                <li>To produce Professionals who can participate in Technical progression to meet the growing global challenges</li><br>
                            </ul>
                            </p>
                        </div>
                    </div>
                    <div class="demo-card demo-card--step1">
                        ...
                        <div class="body">
                            <p>
                            <ul>
                                <li>To enable graduates to develop solutions to real world problems in the frontier areas of Applied Electronics</li><br>
                                <li>To enable the graduates to adapt to the latest trends in technology through self-learning and to pursue research to meet out he demands in industries and Academics.</li><br>
                                <li>To enable the graduates to exhibit leadership skills and enhance their abilities through lifelong learning.</li><br>
                            </ul>
                            </p>
                        </div>
                    </div>
                    <div class="demo-card demo-card--step1">
                        ...
                        <div class="body">
                            ...
                            <ul>
                                ...
                                <li>3. Design/Development of Solutions: Design solutions for complex engineering problems and design systems components or processes that meet the specified needs with appropriate considerations for the public health and safety and the cultural, societal and environmental considerations.</li><br>
                                ...
                                <li>7. Environment and Sustainability: Understand the impact of the professional engineering solutions in societal and environmental contexts and demonstrate the knowledge of and need for sustainable development.</li><br>
                                ...
                                <li>10. Communication: Communicate effectively on complex engineering activities with the engineering community and with society at large, such as, being able to comprehend and write effective report and design documentation, make effective presentations and give and receive clear instructions.</li><br>
                                <li>11. Project Management and Finance: Demonstrate knowledge and understanding of the engineering and management principles and apply these to one’s own work, as a member and leader in a team, to manage projects and in multidisciplinary environments</li><br>
        ...
        <section id="content2">
            <div class="content">
                ...
                <ul class="team">
                    <li class="member">
                        <div class="thumb"><img src="../assets/img/academics/ae/lab1.jpg"></div>
                        <div class="lab_container">
                            <div class="description">
                                <h3 class="lab-heading">Electronics System Design Laboratory</h3>
                                <ul>
                                    <li>Rooted in the year 2012, functioning over a floor area of about 88m2.</li>
                                    <li>To provide system design using PIC, Microcontrollers and Microprocessors and study different interfaces using Embedded microcontroller.</li>
                                    <li>To enable hands on experience on the DSP processor and analyze the different types of sequential circuits.</li>
                                    <li>To understand the design of sensors using simulation tools and analyze real time signal processing system.</li>
                                </ul>
                            </div>
                            <div class="lab_image">
            ...
            <div class="profile-container">
                ...
                <img class="page_under_contruction" src="https://res.cloudinary.com/gracecoe/image/upload/v1666352380/Assets/page-under-construction1_m4j1zp.png" alt=""> -->
                  ...
                  <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                    <div class="our-team">
                        <div class="picture">
                            <img class="img-fluid" src="../assets/img/faculty_images/rangarajan.jpg">
                        </div>
                        ...
                        <div class="social">
                            <a href="../assets/img/faculty_images/rangarajan.jpg" target="pdf" class="link">View Profile</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                    <div class="our-team">
                        <div class="picture">
                            <img class="img-fluid" src="https://res.cloudinary.com/gracecoe/image/upload/v1666360140/Assets/Faculty/AE/acaef1_iknaai.jpg">
                        </div>
                        <div class="faculty-name">
                            Dr.N.Preethi Elizabeth
                            <h4 class="title">Assistant Professor</h4>
                        </div>
                        <div class="social">
                            <a href="../assets/doc/Faculty Profile/Preethi Elizabeth.pdf#toolbar=0" target="pdf" class="link">View Profile</a>
                        </div>
                    </div>
                </div>
