...
<head>
    ...
    <title>GCOE:Master of Business Administration</title>
...
<body>
    ...
    <!-- ENDS -->
    <h1 class="course-main-headng">Master of Business Administration</h1>
    <div class="tb-main">
                ...
                <div class="demo-card-wrapper">
                    <div class="demo-card demo-card--step1">
                        ...
                        <div class="body">
                            <p>
                            <ul>
                                <li>The Department of Master of Business Administration has been introduced in the academic year 2022-2023.</li><br>
                                <li>The Department was started with a vision of developing the rural students to become competitive managers in all functional areas of management to meet global challenges.</li><br>
                                <li>The objective of this programme is to develop young men and women into competent professional managers and bridge the gap in the industry by providing quality management professionals with strong technical skills and an acumen for managing a business, thus meeting the requirements of modern technology based industries. </li><br>
                                <li>The department is fully equipped with campus wifi and Internet facilities</li><br>
                            </ul>
                            </p>
                        </div>
                    </div>
                    <div class="demo-card demo-card--step1">
                        ...
                        <div class="body">
                            <p>
                                Envision to acquire conceptual and interpersonal skills to instill a sense of social purpose and develop leardership qualities by practising collaborative approach.
                            </p>
                        </div>
                    </div>
                    <div class="demo-card demo-card--step1">
                        ...
                        <div class="body">
                            <p>
                            <ul>
                                <li>To become a Centre of Excellence for nurturing creativity, encouraging entrepreneurship and enhancing employability, holistic development of student through enriched teaching and quality research.</li><br>
                                <li> To inculcate managerial and entrepreneurial skills with a zeal to attain excellence in business administration.</li><br>
                                <li>To motivate students gain professional competence through constant knowledge update, empathetic leadership qualities, and fostering strategic relationships with the industry and practitioners.</li><br>
                    ...
                    <div class="demo-card demo-card--step1">
                        ...
                        <div class="body">
                            <p>
                            <ul>
                                <li>1. To have a thorough understanding of the core aspects of the business.</li><br>
                                <li>2. To provide the learners with the management tools to identify, analyze and create business opportunities as well as solve business problems.</li><br>
                                <li>3. To prepare them to have a holistic approach towards management functions.</li><br>
                                <li>4. To inspire and make them practice ethical standards in business.</li><br>
                            </ul>
                            </p>
                        </div>
                    </div>
                    <div class="demo-card demo-card--step1">
                        ...
                        <div class="body">
                            <p>
                            <ul>
                                <li>1. Ability to apply the business acumen gained in practice.</li><br>
                                <li>2. Ability to understand and solve managerial issues.</li><br>
                                <li>3. Ability to communicate and negotiate effectively, to achieve organizational and individual goals</li><br>
                                <li>4. Ability to understand one’s own ability to set achievable targets and complete them.</li><br>
                                <li>5. Ability to fulfill social outreach.</li><br>
                                <li>6. Ability to take up challenging assignments.</li><br>
                            </ul>
                            </p>
                        </div>
                    </div>
        ...
        <section id="content2">
            <div class="content">
                ...
                <ul class="team">
                    <li class="member">
                        <div class="thumb"><img src="https://gracecoe.org/img/pg-pse-lab1.jpg"></div>
        ...
        <section id="content3">
            ...
            <div class="profile-container">
                ...
                <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                    <div class="our-team">
                        <div class="picture">
                            <img class="img-fluid" src="../assets/img/faculty_images/kumarakannan.jpg">
                        </div>
                        ...
                        <div class="social">
                            <a href="https://gracecoe.org/assets/pdf/rampriya.pdf#toolbar=0" target="pdf" class="link">View Profile</a>
                        </div>
                    </div>
                </div> 
             ...
             <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                    <div class="our-team">
                        <div class="picture">
                            <img class="img-fluid" src="../assets/img/faculty_images/manikandan.jpg">
                        </div>
                        <div class="faculty-name">
                          Mr. ManiKandan
                ...
                <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                    <div class="our-team">
                        ...
                        <div class="social">
                            <a href="https://gracecoe.org/assets/doc/Faculty%20Profile/samsu.pdf#toolbar=0" target="pdf" class="link">View Profile</a>
                        </div>
                    </div>
                </div>          
            </div>
