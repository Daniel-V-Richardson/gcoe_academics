    ...
    <div class="sem-container">
        <div class="sem-left">
            <ul>
                ...
                <a href="./5thSemSubjects/PSA.php" class="link">
                    <li>Power System
                        Analysis - EE8501</li>
                </a>
                <a href="./5thSemSubjects/MPMC.php" class="link">
                    <li>Microprocessors and
                        Microcontrollers - EE8551</li>
                </a>
                <a href="./5thSemSubjects/PE.php" class="link">
                    <li>Power Electronics - EE8552</li>
                </a>
                <a href="./5thSemSubjects/DSP.php" class="link">
                    <li>Digital Signal
                        Processing - EE8591</li>
                </a>
