...
<body>
    ...
    <!-- ENDS -->
    <h1 class="course-main-headng">Artificial Intelligence & Data Science</h1>
    <div class="tb-main">
                ...
                <div class="demo-card-wrapper">
                    <div class="demo-card demo-card--step1">
                        ...
                        <div class="body">
                            <p>
                            <ul>
                                <li>The Department of Artificial Intelligence and Data Science has been introduced in the academic year 2022-2023.</li>
                                <li>The department has a well-equipped computer lab with latest computer software. The Laboratories are installed with broad-band internet facility.</li>
                                <li>The objective of the department is to drive the students' commitment to excel in research, design and development of next generation cutting-edge technologies in the area of Artificial Intelligence and Data Analytics. To enable the students to acquire technical skills to perform data processing, analysis and visualization in multiple real-time applications and equip them to identify and assess societal, health, safety and cultural issues with an emphasize on identifying their consequent responsibilities as Engineers of offering optimal and effective solutions for the same. </li>
                    ...
                    <div class="demo-card demo-card--step1">
                        ...
                        <div class="body">
                            ...
                            <ul>
                                ...
                                <li>To serve the society by providing insight solutions to the real world problems by employing the emerging trends of Artificial Intelligence technology with strict adherence to professional and ethical responsibilities.</li>
                            </ul>
                            </p>
                        </div>
                    </div>
                    <div class="demo-card demo-card--step1">
                        ...
                        <div class="body">
                            <p>
                            <ul>
                                <li>Utilize their proficiencies in the fundamental knowledge of basic sciences, mathematics, Artificial Intelligence, data science and statistics to build systems that require management
                                    and analysis of large volumes of data.</li>
                                <li>Advance their technical skills to pursue pioneering research in the field of AI and Data Science and create disruptive and sustainable solutions for the welfare of ecosystems.To provide students with strong foundational concepts and also advanced techniques and tools in order to enable them to build solutions or systems of varying complexity.</li>
                                <li>Think logically, pursue lifelong learning and collaborate with an ethical attitude in a multidisciplinary team.</li>
                                <li>Design and model AI based solutions to critical problem domains in the real world.</li>
                                <li>Exhibit innovative thoughts and creative ideas for effective contribution towards economy building.</li>
                            </ul>
                            </p>
                        </div>
                    </div>
                    <div class="demo-card demo-card--step1">
                        ...
                        <div class="body">
                            <p>
                            <ul>
                                <li>Evolve AI based efficient domain specific processes for effective decision making in several domains such as business and governance domains</li>
                                <li>Arrive at actionable Foresight, Insight, hindsight from data for solving business and engineering problems</li>
                                <li>Create, select and apply the theoretical knowledge of AI and Data Analytics along with practical industrial tools and techniques to manage and solve wicked societal problems</li>
                                <li>Capable of developing data analytics and data visualization skills, skills pertaining to knowledge acquisition, knowledge representation and knowledge engineering,
                                    and hence capable of coordinating complex projects.</li>
                                <li>Able to carry out fundamental research to cater the critical needs of the society through cutting edge technologies of AI.</li>
                            </ul>
                            </p>
                        </div>
                    </div>
                    <div class="demo-card demo-card--step1">
                        ...
                        <div class="body">
                            <p>
                                To analyze, design and develop computing solutions by applying foundational concepts of Artificial Intelligence & Data Science.
                    ...
                    <li class="member">
                        ...
                        <div class="lab_container">
                            <div class="description">
                                ...
                                <ul>
                                    <li>Established in the year 2022-2023</li>
        ...
        <section id="content3">
            ...
            <div class="profile-containerprofile-container">
                <style>
                    .profile-container {
                        align-items: center;
                    }
                ...
                <!-- <div class="col-12 col-sm-6 col-md-4 col-lg-3">
                    <div class="our-team">
                        ...
                        <div class="faculty-name">
                            Mrs Joy Suganthy Bai
                            <h4 class="title">Assistant Professor</h4>
                        </div>
                        <div class="social">
                            <a href="https://gracecoe.org/doc/Joy.pdf#toolbar=0" target="pdf" class="link">View Profile</a>
                        </div>
                    </div>
                </div>
